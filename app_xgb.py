...
hashed_passwords = stauth.Hasher(密码).generate()

authenticator = stauth.Authenticate(names, 用户名, hashed_passwords,
...
"NaClO"
    ...
    st.warning('Please input username or password')
